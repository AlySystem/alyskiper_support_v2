...
const Ejecutivo = props =>{
            ...
            const finalArray = []
              data.searchAgentsByUserId.map(item => {
                ...
                return finalArray.push({
                    ...
                    color: '#000',
                    editar:
                    <Link to={`./ejecutivoeditar/${parseFloat(id)}`} 
  ...
  return(
    ...
    <div className="container2">
      <h1 className="font-weight-bold text-center mb-5 caja-texto-color-blanco font">Ejecutivo</h1>
      <a className='font' href='#1'>Importar a exel</a>
        ...
        <Table
          ...
          expandedRowRender={record => {
           ...
           return record.agente.map(item => {
              ...
              return(
                <Fragment>
                <table className='subtabla' style={{fontFamily: 'Lato, sans-serif' }}>
                  ...
                  <tbody className='subtabla-body'>
                    <tr>
                      <td>
                        <span className='bg-primary' style={{padding:'5px', margin:'20px', borderRadius:'10px'}}>
                      ...
                      <td>
                      {
                      item.state ? <span className='bg-primary' style={{padding:'5px', margin:'20px', borderRadius:'10px'}}>{item.state ? 'Activo' : 'Desactivado' }</span> : null 
                      }
                      </td>
                    </tr>
                  </tbody>
